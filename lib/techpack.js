...
// Noto Sans SC ships in this repo under assets/fonts (SIL Open Font License --
// see assets/fonts/OFL.txt -- fetched from Google's official font repo, so
// it's fine to bundle/redistribute, unlike a copied Windows system font).
// Bundling it means every deployment target (dev machine, any server) just
// works with no separate font install step. The system-font paths below are
// kept only as a fallback if that file is ever missing; TECHPACK_FONT still
